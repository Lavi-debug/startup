                        ...
                        <div className='w-full max-w-[1360px] px-[9px]'>
                            ...
                            <div>
                                <div className='px-[9px] mt-[95px] flex flex-col items-center'>
                                    <h1 className='max-w-[534px] text-[26px] font-[400] text-center'><span className='font-[500]'>Congrutulations!</span> You have successfully completed KYC and registeed as an StartUp with Venture Loop. We will contact you soon</h1>
                                ...
                                <div className='mt-[32px] flex items-center flex-col'>
                                    ...
                                    <div className='flex w-full justify-center mt-[50px]'>
                                        <Link to='/startuplogin' className='flex flex-wrap justify-center items-center mt-[10px]'>
...
export default startupsignupfour
