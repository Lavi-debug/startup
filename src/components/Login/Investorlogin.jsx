...
const Investorlogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch(`${host}/api/investor/check-email`, {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                navigate('/Investormainhomepage', { state: { email } });
            } else {
                        ...
                        <div className="px-[32px] py-[24px] sm3:w-[432px] w-full rounded-[] max-w-full bg-[white] border-[1px] border-[#b7b7b7] shadow-custom4">
                            <div>
                                ...
                                <ul className="flex flex-wrap my-[1.5rem]">
                                    <button className={`mr-[10px] text-[14px] font-[500]`} >
                                        <a href="" className='py-[6px] px-[12px] border-b-[2.5px] border-b-black flex'
                                        >
                                            <img
                            ...
                            <div className="mt-[20px]">
                                ...
                                <div className="flex justify-center">
                                    <a onClick={() => navigate('/inverstorsignup')} className="cursor-pointer mt-[12px] text-[14px] font-[400] text-[#222]">
