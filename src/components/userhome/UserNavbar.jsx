...
const Userhomepage = () => {
  ...
  return (
    ...
    <nav className='fixed top-0 w-full px-[20px] bg-[#222] h-[85px] text-right z-50'>
        <div className='flex gap-[24px] h-full items-center justify-between'>
            ...
            <div className='flex justify-items-start items-center min-w-[250px]'>
                <img src="https://investor.creddinv.in/_next/static/media/hamburger_white.3e4a1984.svg" alt="" className='w-[46px] md5:hidden block'  onClick={() => setIsMenuOpen(!isMenuOpen)} />
                        ...
                        <div>
                            <div className='p-[12px] border-[1px] border-[#d9d9d9] rounded-[8px]'>
                                <div className='flex items-center mb-[6px] w-full gap-[12px]'>
                                    ...
                                    {investorData ? (
                                            <p className="text-[14px] font-[600]">{investorData.yourName}</p>
                                        ) : (
                                            <p>Loading...</p>
                                        )}
                            ...
                            <div>
                                <div>
                                    <Link to='/Personaldetails' className='p-[10px] pl-[18px] flex items-center hover:bg-green-200 ease-in duration-100' onClick={() => setIsOpen5(!isOpen5)}>
                                    ...
                                    {/* <Link to='/Bankdetails' className='p-[10px] pl-[18px] flex items-center hover:bg-green-100 ease-in duration-100' onClick={() => setIsOpen6(!isOpen6)}>
                                    ...
                                    <Link to='/Privaterounddetails' className='p-[10px] pl-[18px] flex items-center hover:bg-green-200 ease-in duration-100' onClick={() => setIsOpen7(!isOpen7)}>
                                    ...
                                    <Link to='/Changepasswod' className='p-[10px] pl-[18px] flex items-center hover:bg-green-200 ease-in duration-100' onClick={() => setIsOpen8(!isOpen8)}>
                                    ...
                                    <Link to='' className='p-[10px] pl-[18px] flex items-center hover:bg-green-200 ease-in duration-300' onClick={() => setIsOpen9(!isOpen9)}>
                                    ...
                                    <Link to='' className='p-[10px] pl-[18px] flex items-center hover:bg-green-200 ease-in duration-100' onClick={() => setIsOpen10(!isOpen10)}>
                                    ...
                                    <Link to='/investorlogin' className='p-[10px] pl-[18px] flex items-center hover:bg-green-100 ease-in duration-200' onClick={() => setIsOpen12(!isOpen12)}>
    ...
    <div className='flex relative'>
        ...
        <div className={`sidebar fixed top-[85px] left-0 md5:block h-[100vh] z-[40] w-[306px] ${
                    ...
                    <div className='pt-[32px] h-[calc(100vh-76px)]'>
                        ...
                        <ul className='relative block'>
                            ...
                            <li onClick={() => setActiveDiv(1)} className="transition-transform transform hover:translate-x-2 ease-in duration-200">
                                <Link to="/Investormainhomepage" className='p-[16px] mb-[12px] flex items-center justify-start rounded-[2px] text-[#b7b7b7]'>
                                    <img src="https://investor.creddinv.in/_next/static/media/product.33bf0db5.svg" alt="" className='mr-[8px] text-[20px]'/>
                                    <span className='text-[16px] font-[400] ml-[8px]'>Home</span>
                                </Link>
                            </li>

                            <li onClick={() => setActiveDiv(2)} className="transition-transform transform hover:translate-x-2 ease-in duration-200">
                                <Link to="/Livecampaigns" className='p-[16px] mb-[12px] flex items-center justify-start rounded-[2px] text-[#b7b7b7]'>
                            ...
                            <li onClick={() => setActiveDiv(3)} className="transition-transform transform hover:translate-x-2 ease-in duration-200">
                                <Link to="/Myportfolioi" className='p-[16px] mb-[12px] flex items-center justify-start rounded-[2px] text-[#b7b7b7]'>
                            ...
                            <li onClick={() => setActiveDiv(4)} className="transition-transform transform hover:translate-x-2 ease-in duration-200">
                                <Link to="/Knowledgecenter" className='p-[16px] mb-[12px] flex items-center justify-start rounded-[2px] text-[#b7b7b7]'>
                            ...
                            <li onClick={() => setActiveDiv(5)} className="transition-transform transform hover:translate-x-2 ease-in duration-200">
                                <Link to="/FAQ" className='p-[16px] mb-[12px] flex items-center justify-start rounded-[2px] text-[#b7b7b7]'>
