                      ...
                      <div className={`profiledropdown absolute bg-white z-50 rounded-[8px] top-[50px] left-[-214px]  ${isProfileOpen ? "block" : "hidden"}`} >
                          <div className='w-[271px] min-h-fit'>
                              <div>
                                  ...
                                  <div>
                                      <div>
                                          <Link to='/Strtupdtls' className='p-[10px] pl-[18px] flex items-center hover:bg-green-100 ease-in duration-100' onClick={() => setIsOpen5(!isOpen5)}>
                                          ...
                                          <Link to='/Strtupabtus' className='p-[10px] pl-[18px] flex items-center hover:bg-green-100 ease-in duration-100' onClick={() => setIsOpen5(!isOpen5)}>
                                              <img src="https://investor.creddinv.in/_next/static/media/persnal_detal.b0983f67.svg" alt="" />
                                          ...
                                          <Link to='/contactus' className='p-[10px] pl-[18px] flex items-center hover:bg-green-100 ease-in duration-100' onClick={() => setIsOpen11(!isOpen11)}>
                                          ...
                                          <Link to='/investorlogin' className='p-[10px] pl-[18px] flex items-center hover:bg-green-100 ease-in duration-100' onClick={() => setIsOpen12(!isOpen12)}>
